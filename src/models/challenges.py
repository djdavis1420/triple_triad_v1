...
def challenges(game, played_card, selected_position, P1, P2):
    if selected_position == 'top_left':
        __top_left_placement(game, played_card, P1, P2)
    if selected_position == 'top_center':
        __top_center_placement(game, played_card, P1, P2)
    if selected_position == 'top_right':
        __top_right_placement(game, played_card, P1, P2)
    if selected_position == 'mid_left':
        __mid_left_placement(game, played_card, P1, P2)
    if selected_position == 'mid_center':
        __mid_center_placement(game, played_card, P1, P2)
    if selected_position == 'mid_right':
        __mid_right_placement(game, played_card, P1, P2)
    if selected_position == 'bot_left':
        __bot_left_placement(game, played_card, P1, P2)
    if selected_position == 'bot_center':
        __bot_center_placement(game, played_card, P1, P2)
    if selected_position == 'bot_right':
        __bot_right_placement(game, played_card, P1, P2)


def __top_left_placement(game, played_card, P1, P2):
    if game.positions['top_center']['card'] is not None and played_card['r_value'] > game.positions['top_center']['card']['l_value']:
        __flip_owner(game.positions['top_center'], P1, P2)
    if game.positions['mid_left']['card'] is not None and played_card['b_value'] > game.positions['mid_left']['card']['t_value']:
        __flip_owner(game.positions['mid_left'], P1, P2)


def __top_center_placement(game, played_card, P1, P2):
    if game.positions['top_left']['card'] is not None and played_card['l_value'] > game.positions['top_left']['card']['r_value']:
        __flip_owner(game.positions['top_left'], P1, P2)
    if game.positions['top_right']['card'] is not None and played_card['r_value'] > game.positions['top_right']['card']['l_value']:
        __flip_owner(game.positions['top_right'], P1, P2)
    if game.positions['mid_center']['card'] is not None and played_card['b_value'] > game.positions['mid_center']['card']['t_value']:
        __flip_owner(game.positions['mid_center'], P1, P2)


def __top_right_placement(game, played_card, P1, P2):
    ...
    if game.positions['mid_right']['card'] is not None and played_card['b_value'] > game.positions['mid_right']['card']['t_value']:
        __flip_owner(game.positions['mid_right'], P1, P2)


def __mid_left_placement(game, played_card, P1, P2):
...
def __mid_center_placement(game, played_card, P1, P2):
    ...
    if game.positions['bot_center']['card'] is not None and played_card['b_value'] > game.positions['bot_center']['card']['t_value']:
        __flip_owner(game.positions['bot_center'], P1, P2)
...
def __mid_right_placement(game, played_card, P1, P2):
...
def __bot_left_placement(game, played_card, P1, P2):
    ...
    if game.positions['mid_left']['card'] is not None and played_card['t_value'] > game.positions['mid_left']['card']['b_value']:
        __flip_owner(game.postions['mid_left'], P1, P2)


def __bot_center_placement(game, played_card, P1, P2):
...
def __bot_right_placement(game, played_card, P1, P2):
